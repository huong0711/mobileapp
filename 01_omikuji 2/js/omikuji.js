...
btn1.addEventListener("click",function(){
   ...
   let resultSound= ["sound/omikuji_sound1.mp3","sound/omikuji_sound2.mp3","sound/omikuji_sound3.mp3","sound/omikuji_sound1.mp3","sound/omikuji_sound4.mp3","sound/omikuji_sound5.mp3"];
